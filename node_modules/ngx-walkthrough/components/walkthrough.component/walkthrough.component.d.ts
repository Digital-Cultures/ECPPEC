...
export declare class WalkthroughComponent implements AfterContentChecked, AfterViewChecked, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<WalkthroughComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<WalkthroughComponent, "ngx-walkthrough", never, { "useButton": "use-button"; "hasGlow": "has-glow"; "isRound": "is-round"; "iconPaddingLeft": "icon-padding-left"; "iconPaddingTop": "icon-padding-top"; "focusElementSelector": "focus-element-selector"; "focusElementInteractive": "focus-element-interactive"; "isActive": "is-active"; "buttonCaption": "button-caption"; "hasBackdrop": "has-backdrop"; "forceCaptionLocation": "force-caption-location"; "walkthroughType": "walkthrough-type"; "mainCaption": "main-caption"; "walkthroughIconWanted": "icon"; "walkthroughHeroImage": "walkthrough-hero-image"; "tipIconLocation": "tip-icon-location"; "tipColor": "tip-color"; }, { "onWalkthroughShowEvent": "on-walkthrough-show"; "onWalkthroughHideEvent": "on-walkthrough-hide"; "onWalkthroughContentClickedEvent": "on-walkthrough-content-clicked"; }, never, ["img", "img"]>;
}

//# sourceMappingURL=walkthrough.component.d.ts.map